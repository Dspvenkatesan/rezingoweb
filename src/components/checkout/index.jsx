            ...
            <div>
                                                ...
                                                <div className="order-box">
                                                    ...
                                                    <ul className="qty">
                                                        {cartItems.map((item, index) => {
                                                            return <li key={index}>{item.name} × {item.qty} <span>{symbol} {item.qty * item.price.formatted}</span></li> })
                                                        }
                                                    </ul>
                                                    <ul className="sub-total">
                                                        <li>Subtotal <span className="count">{symbol}{cartItems
              ...
              .reduce((acc, current) => {
               return acc + current;
                                                    ...
                                                    <ul className="total">
                                                        <li>Total <span className="count">{symbol}{cartItems
              .map((item) => item.qty * item.price.formatted)
              .reduce((acc, current) => {
               return acc + current;
              }, 0)}</span></li>
