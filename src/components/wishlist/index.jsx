                                            ...
                                            <tr>
                                                ...
                                                <td><Link to={`${process.env.PUBLIC_URL}/left-sidebar/product/${item.id}`}>{item.name}</Link>
                                                    <div className="mobile-cart-content row">
                                                        ...
                                                        <div className="col-xs-3">
                                                        <h2 className="td-color">{symbol}{item.price.formatted}</h2>
                                                             {/* <h2 className="td-color">{symbol}{item.price.formatted-(item.price.formatted*item.discount/100)}
                                                            <del><span className="money">{symbol}{item.price.formatted}</span></del>
                                                            </h2> */}
                                                        </div>
                                                        <div className="col-xs-3">
                                                ...
                                                <td>
                                                <h2 className="td-color">{symbol}{item.price.formatted}</h2>
                                                    {/* <h2>{symbol}{item.price.formatted-(item.price.formatted*item.discount/100)}
                                                     <del><span className="money">{symbol}{item.price.formatted}</span></del></h2> */}
                                                     </td>
                                                <td >
                                                    <p>in stock</p>
                                                </td>
