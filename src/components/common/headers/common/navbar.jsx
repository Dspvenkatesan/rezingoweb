                ...
                <div className="main-navbar">
                    <div id="mainnav" >
                        ...
                        <ul className="nav-menu" style={this.state.navClose}>
                            ...
                            <li >
                                <Link to="footer-one" className="nav-link">
                                    About Rezingo
                                    {/* {translate('shop')} */}
                                    {/* <span className="sub-arrow"></span> */}
                                </Link>
                            ...
                            <li >
                                <Link to={`${process.env.PUBLIC_URL}/Collection`} className="nav-link">
                                    Get started
                                    {/* {translate('products')} */}
                                    {/* <span className="sub-arrow"></span> */}
                                </Link>
                            ...
                            <li>
                                <Link to="footer-one" className="nav-link">                               
                                {/* <Link to="footer-one" className="nav-link" onClick={(e) => this.handleSubmenu(e)}> */}
                                    Contact
                                    {/* {translate('pages')} */}
                                    {/* <span className="sub-arrow"></span> */}
                                </Link>
