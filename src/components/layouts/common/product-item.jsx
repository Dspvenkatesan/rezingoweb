    ...
    render() {
        ...
        return (
                <div className="product-box">
                    <div className="img-wrapper">
                        ...
                        <Link to={`${process.env.PUBLIC_URL}/left-sidebar/product/${product.id}`} >
                            <img src={product.media.source} alt={product.name} className="img-fluid lazyload bg-img" />
                            {/* <img
                            src={`${
                                product.variants?
                        ...
                        {/* <Link to={``} title="Compare" onClick={onAddToCompareClicked}>
                        ...
                        <button className="add_cart btn add-to-cart-btn" title="Add to cart" onClick={this.openQuantity}>
                            add to cart
                        </button>
                ...
                <div>
                        ...
                        <h4>{symbol}{product.price.formatted}</h4>
                    </div>
                </div>
